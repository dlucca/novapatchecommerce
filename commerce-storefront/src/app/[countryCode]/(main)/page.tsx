...
export const metadata: Metadata = {
  ...
  description:
    "Descubre los parches médicos más innovadores con beneficios únicos para tu bienestar. Suscripciones disponibles en México y Brasil.",
}
...
export default async function Home(props: {
  ...
  if (featureFlags.ENABLE_COLLECTIONS) {
    try {
