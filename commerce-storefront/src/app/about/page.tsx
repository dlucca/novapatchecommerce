  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        ...
        {/* Inside Our Patch */}
        <div className="bg-gradient-to-r from-novapatch-button to-novapatch-footer rounded-2xl p-12 text-white mb-20">
          <Heading level="h2" className="text-3xl md:text-4xl font-bold mb-8 text-center">
            Dentro de Nuestro Parche
          </Heading>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <Text className="text-lg leading-relaxed mb-6">
                Los ingredientes extraídos y tincturados, clínicamente probados, se mezclan en una capa adhesiva suave, 
                luego se recubren en nuestros parches discretos y potentes.
              </Text>
              <ul className="space-y-3">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                  <Text>Sin Rellenos Artificiales</Text>
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                  <Text>100% Vegano</Text>
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                ...
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                  <Text>Se Activa en Minutos</Text>
                </li>
              </ul>
            </div>
            <div className="bg-white/10 rounded-xl p-6 backdrop-blur-sm">
              ...
              <Text className="leading-relaxed">
                Nuestros cuerpos pueden absorber vitaminas y minerales a través de la piel cuando tienen 
                500 Daltons (peso molecular) o menos. Esto significa una dosis más pequeña, pero la misma 
                biodisponibilidad que las cápsulas o gomitas.
              </Text>
            </div>
          </div>
        </div>
      ...
      <div className="bg-novapatch-bg-light py-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-5xl font-bold text-novapatch-button mb-2">98%</div>
              <Text className="text-gray-700 font-medium">Satisfacción del Cliente</Text>
            </div>
            <div>
              <div className="text-5xl font-bold text-novapatch-button mb-2">50K+</div>
              <Text className="text-gray-700 font-medium">Clientes Felices</Text>
            </div>
            <div>
              <div className="text-5xl font-bold text-novapatch-button mb-2">15+</div>
              <Text className="text-gray-700 font-medium">Productos Únicos</Text>
            </div>
            <div>
              <div className="text-5xl font-bold text-novapatch-button mb-2">100%</div>
              <Text className="text-gray-700 font-medium">Ingredientes Naturales</Text>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-novapatch-button to-novapatch-footer py-20">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <Heading level="h2" className="text-3xl md:text-4xl font-bold mb-6">
            Prueba Nuestros Parches
          </Heading>
          <Text className="text-xl mb-8 opacity-90">
            Con ingredientes premium limpios que te acompañan a donde vayas
          </Text>
