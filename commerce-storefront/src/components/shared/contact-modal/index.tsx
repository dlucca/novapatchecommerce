                ...
                <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                  <div className="flex flex-col gap-2 text-sm text-gray-600">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-2">
                      <a
                        href="mailto:info@novapatch.care"
                        className="flex items-center gap-2 hover:text-novapatch-primary transition-colors whitespace-nowrap"
                      >
                        <svg className="w-4 h-4 text-novapatch-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        <span>info@novapatch.care</span>
                      </a>
                      <a
                        href="tel:+525545451328"
                        className="flex items-center gap-2 hover:text-novapatch-primary transition-colors whitespace-nowrap"
                      >
                        <svg className="w-4 h-4 text-novapatch-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                        </svg>
                        <span>55 4545 1328</span>
                      </a>
                    </div>
                    {/* Dirección en su propia fila */}
                    <div className="flex items-start gap-2">
                      <svg className="w-4 h-4 text-novapatch-primary flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                      <span>Privada Lago Bolsena 22, Col. Modelo Pensil, CP 11450, Miguel Hidalgo, CDMX</span>
                    </div>
                  </div>
                </div>
              </Dialog.Panel>
